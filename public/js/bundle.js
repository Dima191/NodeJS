    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          } else (0, _alerts.showAlert)('error', 'Wrong Email Or Password');
          _context.next = 7;
          return res.json();
        case 7:
          data = _context.sent;
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          res = _context2.sent;
          if (res.ok) location.reload(true);else (0, _alerts.showAlert)('error', 'Something went wrong');
          _context2.next = 6;
          return res.json();
        case 6:
          data = _context2.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          console.log(_typeof(photoFile), photoFile, JSON.stringify(photoFile));
          url = type === 'password' ? 'updateMyPassword' : 'updateMe';
          _context.next = 9;
          return fetch("http://127.0.0.1:3000/api/v1/users/".concat(url), {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
            },
        ...
        case 9:
          res = _context.sent;
          if (res.ok) (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully"));else (0, _alerts.showAlert)('error', 'Try again');
          _context.next = 16;
          break;
        case 13:
          _context.prev = 13;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGltYTExMTYiLCJhIjoiY2xkYzUxbG04MDdhZzNucTUxdmw5ZGQxYiJ9.pQIOyVSbiuQEHDq5kyTCDQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/dima1116/cldc648t4000001ptvh0hdge0',
    scrollZoom: false
  });
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MSSKDK4B9cvCaD2p1hJAAwxawv64XyuDKqY6VrYQqjmEIBF6j7Q5mw2h0JtymnpDKcPFrmdabbahCHLvL1W6BvH00f97kXgRH');
...
var logOut = document.querySelector('.nav__el--cta');
